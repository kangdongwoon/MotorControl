...
void InitTimer0(){
	...
	TIMSK = 0x01; // Overflow Interrupt : 1ms
}
...
void InitTimer1(){
	...
	//TO DO
	TCCR1A = 0b11100010; // OC1A set, OC1B clear
	TCCR1B = 0b00010001; // PWM mode(Top : ICR), 1 Prescaler
		
	ICR1 = 399; // 40000Hz PWM Generator
	OCR1C = 0;
...
void InitTimer3(){
	...
	TCCR3A = 0b10110010; // OC3A clear, OC3B set
	TCCR3B = 0b00010001; // PWM mode(Top : ICR), 1 Prescaler
